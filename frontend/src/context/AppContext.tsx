...
interface AppContextType {
  ...
  mapStyle: MapStyle;
  placeOrder: (cart: CartItem[], total: number, deliveryLocationId: string, restaurantId: string) => void;
...
export const AppProvider: FC<{children: ReactNode}> = ({ children }) => {
  ...
  const placeOrder = useCallback((cart: CartItem[], total: number, deliveryLocationId: string, restaurantId: string) => {
    if (!API_BASE) {
